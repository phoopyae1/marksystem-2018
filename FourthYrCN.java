 ...
 * @author lenovo
 */
public class FourthYrCN extends javax.swing.JPanel {
...
/**
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Fourth Year's CN");
    ...
    private void InsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InsertActionPerformed
     ...
     InsertDBCN insert=new InsertDBCN();
     ...
     insert.SE406=Integer.parseInt(SE406.getText());
      ...
      insert.SETotal=total;
        try {
            ...
            Logger.getLogger(FourthYrCN.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(FourthYrCN.class.getName()).log(Level.SEVERE, null, ex);
        }
        CNcaculategrade caculate=new CNcaculategrade();
