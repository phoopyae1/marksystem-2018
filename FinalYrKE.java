 ...
 * @author lenovo
 */
public class FinalYrKE extends javax.swing.JPanel {
...
/**
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Final Year's KE");
    ...
    private void InsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InsertActionPerformed
     ...
     InsertDBFFinalKE insert=new InsertDBFFinalKE();
     ...
     insert.SE506=Integer.parseInt(SE406.getText());
      ...
      insert.SETotal=total;
        try {
            ...
            Logger.getLogger(FinalYrKE.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(FinalYrKE.class.getName()).log(Level.SEVERE, null, ex);
        }
        FinalKEgrade caculate=new FinalKEgrade();
