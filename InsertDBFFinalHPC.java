 ...
 * @author lenovo
 */
public class InsertDBFFinalHPC {
    String SERollno;
    String SENAME;
       ...
       public void csinsert() throws SQLException, ClassNotFoundException
    {
        ...
        try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost/marksystem","root","")) {
            ...
            String query="INSERT INTO `final_yearhpc`(`Rollno`, `Name`, `501`, `Eng`, `502`, `503`,`504`, `505`, `506`,`Total`) VALUES ('"+SERollno+"','"+SENAME+"',"+SE501+","+SEEng+","+SE502+","+SE503+","+SE504+","+SE505+","+SE506+","+SETotal+")";
            int i;
