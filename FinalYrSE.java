 ...
 * @author lenovo
 */
public class FinalYrSE extends javax.swing.JPanel {
...
/**
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Final Year's SE");
    ...
    private void InsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InsertActionPerformed
     ...
     InsertDBFFinalSE insert=new InsertDBFFinalSE();
     ...
     insert.SE506=Integer.parseInt(SE406.getText());
      ...
      insert.SETotal=total;
        try {
            ...
            Logger.getLogger(FinalYrSE.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(FinalYrSE.class.getName()).log(Level.SEVERE, null, ex);
        }
        FinalSEgrade caculate=new FinalSEgrade();
