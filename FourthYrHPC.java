 ...
 * @author lenovo
 */
public class FourthYrHPC extends javax.swing.JPanel {
...
/**
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Fourth Year's HPC");
    ...
    private void InsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InsertActionPerformed
     ...
     InsertDBHPC insert=new InsertDBHPC();
     ...
     insert.SE406=Integer.parseInt(SE406.getText());
      ...
      insert.SETotal=total;
        try {
            ...
            Logger.getLogger(FourthYrHPC.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(FourthYrHPC.class.getName()).log(Level.SEVERE, null, ex);
        }
        HPCcaculategrade caculate=new HPCcaculategrade();
