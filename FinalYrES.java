 ...
 * @author lenovo
 */
public class FinalYrES extends javax.swing.JPanel {
...
/**
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Final Year's Es");
    ...
    private void InsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InsertActionPerformed
     ...
     InsertDBFFinalES insert=new InsertDBFFinalES();
     ...
     insert.SE506=Integer.parseInt(SE406.getText());
      ...
      insert.SETotal=total;
        try {
            ...
            Logger.getLogger(FinalYrES.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(FinalYrES.class.getName()).log(Level.SEVERE, null, ex);
        }
        FinalESgrade caculate=new FinalESgrade();
