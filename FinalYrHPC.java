 ...
 * @author lenovo
 */
public class FinalYrHPC extends javax.swing.JPanel {
...
/**
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Final Year's High Performance computing");
    ...
    private void InsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InsertActionPerformed
     ...
     InsertDBFFinalHPC insert=new InsertDBFFinalHPC();
     ...
     insert.SE506=Integer.parseInt(SE406.getText());
      ...
      insert.SETotal=total;
        try {
            ...
            Logger.getLogger(FinalYrHPC.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(FinalYrHPC.class.getName()).log(Level.SEVERE, null, ex);
        }
        FinalHPCgrade caculate=new FinalHPCgrade();
