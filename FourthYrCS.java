 ...
 * @author lenovo
 */
public class FourthYrCS extends javax.swing.JPanel {
...
/**
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Fourth Year's CS");
    ...
    private void InsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InsertActionPerformed
     ...
     InsertDBFCS insert=new InsertDBFCS();
     ...
     insert.SE406=Integer.parseInt(SE406.getText());
      ...
      insert.SETotal=total;
        try {
            ...
            Logger.getLogger(FourthYrCS.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(FourthYrCS.class.getName()).log(Level.SEVERE, null, ex);
        }
        FCScaculategrade caculate=new FCScaculategrade();
