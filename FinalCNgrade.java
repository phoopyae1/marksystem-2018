...
public class FinalCNgrade {
  ...
  String query="INSERT INTO `final_yearcn's_grade`(`Rollno`, `Name`, `501`, `Eng`, `502`, `503`, `504`, `505`, `506`,`Total`) VALUES ('"+SERollno+"','"+SEName+"','"+SE501+"','"+SEEng+"','"+SE502+"','"+SE503+"','"+SE504+"','"+SE505+"','"+SE506+"',"+SETotal+")";
            int i; 
