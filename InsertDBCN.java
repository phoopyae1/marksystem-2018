...
public class InsertDBCN {
       ...
       public void csinsert() throws SQLException, ClassNotFoundException
    {
        ...
        try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost/marksystem","root","")) {
            ...
            String query="INSERT INTO `fourth_yearcn`(`Rollno`, `Name`, `401`, `Eng`, `402`, `403`,`404`, `405`, `406`,`Total`) VALUES ('"+SERollno+"','"+SENAME+"',"+SE401+","+SEEng+","+SE402+","+SE403+","+SE404+","+SE405+","+SE406+","+SETotal+")";
            int i;
