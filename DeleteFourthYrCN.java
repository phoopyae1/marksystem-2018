...
public class DeleteFourthYrCN {
    ...
    public void delete() throws SQLException, ClassNotFoundException
    {
            ...
            String query="DELETE FROM `fourth_yearcn's_grade` WHERE Rollno='"+ROLLNO+"'";
    ...
    public void delete1() throws SQLException, ClassNotFoundException
    {
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost/marksystem","root","");
            Statement stmt=con.createStatement();
            String query="DELETE FROM `fourth_yearcn` WHERE Rollno='"+ROLLNO+"'";
            int i=stmt.executeUpdate(query);
            if(i==1)
            {
                System.out.println("Data delete");
