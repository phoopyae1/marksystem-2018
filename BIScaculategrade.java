...
public class BIScaculategrade {
  ...
  String query="INSERT INTO `fourth_yearbis's_grade`(`Rollno`, `Name`, `401`, `Eng`, `402`, `403`, `404`, `405`, `406`,`Total`) VALUES ('"+SERollno+"','"+SEName+"','"+SE401+"','"+SEEng+"','"+SE402+"','"+SE403+"','"+SE404+"','"+SE405+"','"+SE406+"',"+SETotal+")";
            int i; 
