 ...
 * @author lenovo
 */
public class FourthYrSE extends javax.swing.JPanel {
...
/**
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Fourth Year's Software Engineering");
    ...
    private void InsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InsertActionPerformed
     ...
     InsertDBSE insert=new InsertDBSE();
     ...
     insert.SE406=Integer.parseInt(SE406.getText());
      ...
      insert.SETotal=total;
        try {
            ...
            Logger.getLogger(FourthYrSE.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(FourthYrSE.class.getName()).log(Level.SEVERE, null, ex);
        }
        SEcaculategrade caculate=new SEcaculategrade();
