 ...
 * @author lenovo
 */
public class FinalYrCN extends javax.swing.JPanel {
...
/**
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Final Year's CN");
    ...
    private void InsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InsertActionPerformed
     ...
     InsertDBFFinalCN insert=new InsertDBFFinalCN();
     ...
     insert.SE506=Integer.parseInt(SE406.getText());
      ...
      insert.SETotal=total;
        try {
            ...
            Logger.getLogger(FinalYrCN.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(FinalYrCN.class.getName()).log(Level.SEVERE, null, ex);
        }
        FinalCNgrade caculate=new FinalCNgrade();
