 ...
 * @author lenovo
 */
public class FourthYrES extends javax.swing.JPanel {
...
/**
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Fourth Year's ES");
    ...
    private void InsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InsertActionPerformed
     ...
     InsertDBES insert=new InsertDBES();
     ...
     insert.SE406=Integer.parseInt(SE406.getText());
      ...
      insert.SETotal=total;
        try {
            ...
            Logger.getLogger(FourthYrES.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(FourthYrES.class.getName()).log(Level.SEVERE, null, ex);
        }
        EScaculategrade caculate=new EScaculategrade();
